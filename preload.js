...
contextBridge.exposeInMainWorld('api', {
  ...
  preExitFullscreen:     ()  => ipcRenderer.invoke('pre-exit-fullscreen'),
  anchorToCurrentSpace:  ()  => ipcRenderer.invoke('anchor-to-current-space'),
  floatOverAllSpaces:    ()  => ipcRenderer.invoke('float-over-all-spaces'),
  ...
  loadRenameHistory: ()  => ipcRenderer.invoke('load-rename-history'),
  saveRenameHistory: (d) => ipcRenderer.invoke('save-rename-history', d),
  ...
  activateTrial:   (email) => ipcRenderer.invoke('activate-trial', email),
  ...
  inspectorEnsureOpen:        ()        => ipcRenderer.invoke('inspector-ensure-open'),
  inspectorShrink:            ()        => ipcRenderer.invoke('inspector-shrink'),
  inspectorMasterQuick:       ()        => ipcRenderer.invoke('inspector-master-quick'),
  setInspectorMasterPlugin:   (i, a)    => ipcRenderer.invoke('set-inspector-master-plugin', i, a),
  inspectorNavigateForMaster: (maxSteps = 50) => ipcRenderer.invoke('inspector-navigate-for-master', maxSteps),
  ensureInspectorOpen:        ()        => ipcRenderer.invoke('ensure-inspector-open'),
  ...
  enterScanBadge:  (mon)      => ipcRenderer.invoke('enter-scan-badge', mon),
  ...
  setLocatorsByMarker: (name, keepML, extMode) => ipcRenderer.invoke('set-locators-by-marker', name, keepML, extMode),
  positionMarkerList:  ()   => ipcRenderer.invoke('position-marker-list'),
  ...
  onOverlayUserClosed:   (cb)  => ipcRenderer.on('overlay-user-closed', () => cb()),
